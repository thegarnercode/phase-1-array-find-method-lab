...
//const { KeyboardReturnRounded, Score } = require("@material-ui/icons")
...
const record = [
    ...
    const superbowlWin = function (record){
      const denverWin = record.find(obj => obj.result === "W")
    //console.log(denverWin)
    // console.log(record.year)
    // console.log(denverWin)
    // console.log(denverWin.year)
    if (denverWin){
  ...
  //  //const sadReality = record.find(function (records){
  //   // return records.year === "2018"
  //  })
